...
//    @Autowired
//    UseUserLoginService useUserLoginService;
//
//
//    //进入方法前
//    @Override
...
//            if (claims != null) {
//                String sysid = (String) claims.get("sysid");
//                String identification = (String) claims.get("identification");
//                UseUserLogin useUserLogin = useUserLoginService.getUserLoginByUserId(sysid);
//
//                if (!(identification.equals(useUserLogin.getIdentification()))) {
//                    map.put("code", 201);
//                    map.put("message", "您的账号已在其他地方登录,您已被强制下线,请重新登录");
//                    sendMessage(response, map);
//                    return false;
//                }
//                useUserLogin.setConnectTime(new Date());
//                useUserLoginService.updateUserLoginConTime(useUserLogin);
